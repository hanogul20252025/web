                            ...
                            <div class="col-lg-4 col-md-10">
                                <div class="contact-item">
                                    ...
                                    <div class="content">
                                        ...
                                        <a href="http://maps.gomaps.pro/maps?z=12&t=m&q=loc:{{ isset($default_location['lat']) ? $default_location['lat'] : '0' }}+{{ isset($default_location['lng']) ? $default_location['lng'] : '0' }}" target="_blank"
