                        ...
                        @if (!in_array($order['order_type'],['dine_in','take_away']))
                            ...
                            @if (isset($address))
                                <span class="d-block mb-2">
                                    <a target="_blank"
                                        href="http://maps.gomaps.pro/maps?z=12&t=m&q=loc:{{ $address['latitude'] }}+{{ $address['longitude'] }}">
...
@push('script_2')
<script
src="https://maps.gomaps.pro/maps/api/js?key={{ \App\Models\BusinessSetting::where('key', 'map_api_key')->first()->value }}&libraries=places&callback=initMap&v=3.45.8">
</script>
