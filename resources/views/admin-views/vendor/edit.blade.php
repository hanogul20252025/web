...
@push('script_2')
    ...
    <script
    src="https://maps.gomaps.pro/maps/api/js?key={{ \App\Models\BusinessSetting::where('key', 'map_api_key')->first()->value }}&loading=async&libraries=drawing,places&v=3.58&language={{ str_replace('_', '-', app()->getLocale()) }}&callback=initMap&libraries=marker">
</script>
<script>
    "use strict";
